...
#SBATCH -c 8
#SBATCH --mem=16G
#SBATCH --output=/scratch/prj/bcn_marzi_lab/ratlas/Mingshen/alignment/merge.out
#SBATCH --array=1-17
...
samtools merge \
  /scratch/prj/bcn_marzi_lab/ratlas/Mingshen/alignment/BAM/merged/${file}.bam \
  ${BAM_DIR}/${file}_L001.bam \
  ${BAM_DIR}/${file}_L002.bam
